...
<head>
    ...
    <title> Outdoor - Fechar compra </title>
</head>
...
<body>  
        ...
        <div class="rectangle">
            <div class="left-side">
                <div class="sides">
                    ...
                    <a id="bairro"> d </a>
                    <a id="logradouro"> d</a>
                    <a class="last-side" id="casanumero"> d</a>
                ...
                <?php
                    ...
                    $conta = 'R$ ' . number_format($conta, 2, ',', '.');

                    echo "<a class='valor'> Valor:  $conta</a>";
                ?>
                <a id="fechar" class="pagar"> Pagar compra </a>
            </div>
    ...
    <script>
        $('#fechar').click(function() {
            window.location.href='../CLIENT/pagar_compra.php';
        });
    </script>
